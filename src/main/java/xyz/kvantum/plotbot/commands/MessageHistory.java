...
@CommandDeclaration(command = "history", usage = "!history [user] [limit=5] [channel]", description = "See a history of user messages")
public class MessageHistory extends Command {
    ...
    @Override public boolean onCommand(CommandInstance instance) {
        ...
        final MessageBuilder messageBuilder =
            new MessageBuilder("Last ").append(messageAmount).append(" messages from ")
