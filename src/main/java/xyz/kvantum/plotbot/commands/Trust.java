...
@CommandDeclaration(command = "trust", usage = "!nick [newnick]", permission = "trust", description = "Show that you trust someone :)") public class Trust
		extends Command
{
		...
		} else
		{
			...
			} else
			{
				...
				discordCommandCaller.getChannel()
						.sendMessageFormat( "Congratulations, %s, someone trusts you!", member ).queue();
			}
		}
		return true;
	}
