...
@CommandDeclaration(command = "spigot", description = "Get spigot stats") public class Spigot extends Command
{
	...
	@Override public boolean onCommand(@NonNull final CommandInstance instance)
	{
		...
		final Request request = new Request.Builder()
				.url( "https://api.spiget.org/v2/resources/" + BotConfig.CmdSpigot.resourceId ).get().build();
		try
		{
