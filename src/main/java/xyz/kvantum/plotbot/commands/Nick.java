...
@CommandDeclaration(command = "nick", permission = "setnick", description = "Set plot nickname")
public class Nick extends Command {
    ...
    @Override public boolean onCommand(final CommandInstance instance) {
        ...
        commandCaller.getSuperCaller().getGuild().getController()
            .setNickname(commandCaller.getSuperCaller().getGuild().getSelfMember(),
                instance.getString("nick")).complete();
